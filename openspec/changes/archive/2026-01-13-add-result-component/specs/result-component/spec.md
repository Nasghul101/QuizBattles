...
## Purpose
A reusable UI component that displays a round summary for a single category, showing the category icon and three answer outcome indicators with clickable review functionality.
