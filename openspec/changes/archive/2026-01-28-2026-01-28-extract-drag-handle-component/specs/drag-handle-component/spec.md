...
## Purpose
A reusable UI component that provides drag interaction functionality for popup panels, enabling drag-to-dismiss behavior with configurable directions and thresholds.
