...
## Purpose
Provide an interactive UI for players to create new accounts with username, password, and email validation. Ensures data quality and prevents duplicate usernames while maintaining a simple, non-intrusive user experience.
