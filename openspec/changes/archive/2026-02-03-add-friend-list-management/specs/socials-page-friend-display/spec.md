# Spec Delta: Socials Page (Friend List Display)
...
None. This is a new feature added to the socials page. Existing popup animation functionality remains unchanged.
